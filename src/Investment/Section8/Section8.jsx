...
export default function Section8() {
  ...
  return (
    <section className="relative flex flex-col items-center gap-16 pt-24 pb-40 px-[136px]">
      {/* Header */}
      <div className="flex flex-col items-start gap-2.5 w-full max-w-[640px]">
        <h2 className="font-bold text-gray-800 text-base tracking-wide leading-5">
          The Results Speaks for Themselves
        </h2>

        <div className="flex flex-wrap items-start gap-2">
          <h1 className="font-bold text-gray-800 text-6xl">Price rate of</h1>
          <div className="relative">
            <div className="absolute inset-0 h-[72px] bg-yellow-400" />
            <span className="relative font-bold text-gray-800 text-6xl">
              Gold and Silver
            </span>
          </div>
        </div>
      ...
      {/* Main Content */}
      <div className="flex w-full max-w-[1240px] items-start relative">
        {/* Left Text + Cards */}
        <div className="flex flex-col w-[640px] gap-6">
          ...
          <p className="text-gray-600 text-base tracking-wide">
            ...
            market trends, or evaluating long-term movements, accurate insights 
            give you the confidence to invest wisely and grow your wealth securely.
          </p>
          ...
          <div className="flex gap-6 w-full">
            {priceCards.map((card, index) => (
              <div
                key={index}
                className={`flex flex-col items-center justify-center p-6 w-[200px] ${card.bgColor} rounded-xl border ${card.borderColor}`}
              >
                <div className="font-bold text-gray-600 text-3xl">
                  {card.price}
                </div>
        ...
        {/* Right Side Image */}
        <div className="absolute right-[-267px] top-[-100px] w-[980px] h-[620px]">
          <img
            src="/Investment/lp.svg"
            alt="Rate chart showing gold and silver price trends"
