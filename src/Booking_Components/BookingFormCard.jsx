...
//   <span className={cn("w-4 h-4 object-contain inline-block", className)}>
//     {src}
//   </span>
// );
...
//   if (!open) return null;
//   return (
//     <ModalShell title="Service you want" onClose={onClose} width="max-w-[520px]">
//       <div className="space-y-3">
...
//                 {s.label}
//               </span>
//               {active ? <Img src={ASSETS.check} /> : <span />}
//             </button>
//           );
//         })}
//       </div>
...
//     if (!accepted) return "Please accept the Policies & Important Notes";
//     return null;
//   }
...
/* ================== API HELPERS ================== */
// ✅ FIXED: Use your backend URL (port 8000)
// const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:8000';
// const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://booking.finsbee.com';

// const ENDPOINT = {
//   save: `${API_BASE_URL}/api/bookings/save-step`,
//   create: `${API_BASE_URL}/api/bookings/create`,
//   confirm: `${API_BASE_URL}/api/bookings/confirm`,
// };

// async function postJSON(url, body) {
//   log("📤 API Request:", url, body);
//   const res = await fetch(url, {
//     method: "POST",
//     headers: { "Content-Type": "application/json" },
//     body: JSON.stringify(body),
...
//   }
//   catch { 
//     err("❌ API Parse Error:", text.slice(0,200));
...
/* ================== API HELPERS ================== */
// ✅ PRODUCTION: Using your production backend URL
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://booking.finsbee.com';
...
export default function BookingFormCard() {
  ...
  //     }
  //   } catch (e) { 
  //     err("saveStep failed", e);
  //     // Don't show toast for save-step failures to avoid spamming user
  //   }
  // }
