    ...
    <main className="flex items-center gap-[120px] px-[136px] py-12 relative self-stretch w-full flex-[0_0_auto]">
      <div className="flex flex-col items-center gap-[50px] relative flex-1 grow">
        <div className="flex items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
          <section className="flex flex-col w-[650px] items-start  relative self-stretch translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
            ...
            <p className="self-stretch text-[#FFEEC3]  text-[20px] relative pt-5">
