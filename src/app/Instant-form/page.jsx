...
//               disabled={loading}
//             >
//               {loading ? "Submitting..." : (isHighLoanAmount ? "Submit Application" : "Save & Continue")}
//             </button>
//           </div>
//         )}
...
//           <div className="flex flex-col items-center w-full max-w-lg py-12 px-8 bg-transparent">
//             <div className="mb-8">
//               <img src="/form_page/not_applicable.svg" alt="Application Submitted" className="mx-auto h-50" />
//             </div>
//             <div className="text-center text-xl text-[#183153] font-medium">
//               <div>Your application has been submitted successfully!</div>
//               <div className="mt-5">Our team will reach out to you shortly<br />to discuss your loan options.</div>
//             </div>
