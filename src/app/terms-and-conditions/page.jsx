...
export const metadata = {
  ...
  description: "Read the terms and conditions for using FinsBee's services, including loan applications and financial services.",
};
...
/>
      ...
      <div className=" relative mx-4 z-20 -mt-20 sm:-mt-35 md:-mt-55 md:mx-[136px] p-3 md:p-12 text-gray-800 bg-white rounded-2xl shadow-[0_10px_10px_rgba(0,0,0,0.12)] border border-gray-100 mb-30 md:mb-20">
          ...
          <p className="text-sm text-gray-600">
            ...
            such supplemental terms will be disclosed to You regarding the
          ...
          <div className="space-y-6">
            <section>
              ...
              <div className="space-y-2">
                <p>
                  ...
                  continued to be fulfilled. If You are an
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    or otherwise have been duly complied with.
                  </li>
                </ul>
              </div>
            </section>
              ...
              <div className="space-y-4">
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    seek or result in FinsBee’s termination of this agreement
                  ...
                  <li>
                    ...
                    security approach distributed at{" "}
              ...
              <div className="space-y-4">
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    of FinsBee’s Service. Any dispute between FinsBee Partner
                  ...
                  <li>
                    ...
                    agency where FinsBee’s analysis determines that the
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      ...
                      expressly permitted by FinsBee.
                    </li>
                    <li>
                    ...
                    <li>
                      FinsBee shall have the ongoing right to monitor your
                  ...
                  <div className="space-y-4">
                    ...
                    <p>
                      ...
                      are solely responsible for any User Generated Content you
                      upload, download, post, email, transmit, store or
                      otherwise make available through your use of the Service.
                      FinsBee does not control the User Generated Content used
                    ...
                    <p>
                      ...
                      such as data files, device characteristics, written text,
                    ...
                    <p>
                      ...
                      in providing the Service, but FinsBee does not guarantee
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  entering into this agreement, You have chosen to use the
                  ...
                  from viruses and malicious attacks, FinsBee does not
                  ...
                  integrity of the systems or FinsBee’s computer servers,
                ...
                <li>
                  ...
                  disclaim and expressly waive all other conditions,
            ...
            <section>
              ...
              <p>
                In the course of your dealings with FinsBee, either party may
            ...
            <section>
              ...
              <p className="uppercase">
                ...
                (INCLUDING NEGLIGENCE) OR OTHERWISE FOR ANY LOSS OF PROFITS,
                BUSINESS, CONTRACTS, OR REVENUES, LOSS OF OPERATION TIME,
                INCREASED COSTS OR WASTED EXPENDITURE, LOSS OF GOODWILL OR
                REPUTATION, SPECIAL, INDIRECT, INCIDENTAL, PUNITIVE
                OR CONSEQUENTIAL DAMAGE OF ANY NATURE WHATSOEVER OR HOWSOEVER
            ...
            <section>
              ...
              <p>
                You shall defend, indemnify and hold harmless FinsBee, its
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  FinsBee’s service providers or Partner.
                </li>
                <li>
                  Any claim that the User Generated Content you submitted caused
                  damage to FinsBee or FinsBee’s Partner.
                </li>
                <li>
                  ...
                  indemnification obligation under this Section will survive
            ...
            <section>
              ...
              <p>
                ...
                your use of the Service in accordance with FinsBee’s Privacy
                Policy and these Terms. FinsBee’s Privacy Policy applies to all
            ...
            <section>
              ...
              <p>
                ...
                deemed given upon receipt when sent through
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                ...
                <li>email – <a href="mailto:customercare@finsbee.com">customercare@finsbee.com</a></li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                Stradex International Private Limited provides a variety of
                products and services to our valuable users. It goes as follows:
                <br />
                - FinsBee is an electronic platform which acts as a
                ...
                user can redeem these virtual coins on the FinsBee platform. This
                is a promotional activity done by Stradex International Private
                Limited and has all the rights to suspend or discontinue the
            ...
            <section>
              ...
              <p>
                ...
                unless expressly agreed to in writing or acknowledged in writing
                by FinsBee.
                <br />
