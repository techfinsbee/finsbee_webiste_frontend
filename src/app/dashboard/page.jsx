...
//       {/* HEADER */}
//       <div className="relative bg-gradient-to-r from-[#3C1E86] to-[#5A36D6] rounded-b-[80px] px-10 py-6 flex justify-between items-center text-white shadow-lg">
...
//           </div>
//           <div className="relative  rounded-3xl h-[130px] flex items-center justify-center overflow-hidden">
...
//     <h2 className="text-3xl font-semibold text-[#6A6A6A] leading-tight">
//       Finsbee keeps your
//     </h2>
//     <h2 className="text-3xl font-semibold text-[#6A6A6A] leading-tight">
//       data safe
...
//           className={`px-6 py-3 ${tab === "personal" ? "bg-[#EAE7F5] font-medium" : "text-gray-500"}`}
//         >
//           Personal Detail
//         </button>
...
//         <button
//           onClick={() => setTab("pan")}
//           className={`px-6 py-3 ${tab === "pan" ? "bg-[#EAE7F5] font-medium" : "text-gray-500"}`}
//         >
//           PAN Detail
//         </button>
...
//           className={`px-6 py-3 ${tab === "employment" ? "bg-[#EAE7F5] font-medium" : "text-gray-500"}`}
//         >
//           Employment Detail
//         </button>
//       </div>
...
//           <Input label="First Name (as per aadhaar)" />
//           <Input label="Last Name (as per aadhaar)" />
//           <Input label="Your Date of Birth" type="date" />
//           <Input label="Gender" />
//           <Input label="Pincode" />
//           <Input label="Your Email Id" />
//         </div>
//       )}
...
//           <Input label="Full Name (as per PAN)" />
//           <Input label="Father's Name" />
//           <Input label="PAN Linked Mobile" />
//           <Input label="PAN Linked Email" />
//           <Input label="PAN Issue Date" type="date" />
//         </div>
//       )}

//       {tab === "employment" && (
//         <div className="grid grid-cols-2 gap-6">
//           <Input label="Employment Type" />
//           <Input label="Company Name" />
//           <Input label="Monthly Income" />
//           <Input label="Work Experience (Years)" />
//           <Input label="Office Address" />
//           <Input label="Office Pincode" />
//         </div>
//       )}
//     </div>
//   );
