...
//   // Intersection Observer for tab switching
//   useEffect(() => {
//     const options = {
//       root: null,
...
//       const top = targetRef.current.offsetTop - headerHeight;
//       window.scrollTo({ top, behavior: "smooth" });
//     }
//   };

//   return (
//     <div className="relative flex flex-col lg:flex-row gap-8 px-4 sm:px-8 md:px-16 lg:px-[136px] py-12 md:py-16 lg:py-24 bg-white">

//       {/* ====================== LEFT SECTION ====================== */}
//       <div className="w-full lg:w-2/3">
//         <div className="flex flex-col items-start w-full">

//           {/* Sticky Tab Header - sticks at top-9 */}
//           <div className="sticky top-9 z-30 w-full bg-white border-b border-[#bababa] overflow-hidden pt-2">
//             <div className="flex w-full max-w-[788px] overflow-hidden">
...
//               className="grid grid-cols-2 justify-center md:justify-start gap-4 pt-4 pb-4 px-4 border border-[#eeeaff] rounded-2xl mb-8"
//             >
//               {whyFinsbeeFeatures.map((feature, i) => (
//                 <div
//                   key={i}
//                   className="w-full sm:w-[48%] md:w-[45%] lg:w-[370px] h-[162px]"
//                 >
...
//                 Discounting lets you unlock funds locked in unpaid invoices,
//                 so you don't need to wait for customer payments. It's a fast,
...
//         <div className="sticky top-0 self-start h-fit w-full max-w-[432px]">
...
//               </h2>
//             </div>
//             <div className="bg-gray-50 rounded-[60px_16px_16px_16px] p-6 md:p-8 mt-8 flex flex-col gap-16">
...
//     title: "No Prepayment Penalties",
//     description:
//       "Pay off your loan early without additional charges after 6 months",
//   },
//   {
//     icon: "https://c.animaapp.com/mgex7opoop3dGI/img/user-avatar-4.png",
//     title: "Minimal Documentation",
...
//     question: "How is Finsbee different from banks or agents?",
//     answer:
//       "Finsbee offers unbiased, tailored advice without pushing products, unlike banks or agents who may prioritize sales.",
//   },
//   {
//     question: "What are your plans and pricing?",
//     answer:
//       "We offer various plans tailored to your needs. Visit our website for detailed pricing information.",
//   },
//   {
//     question: "Can you help me secure a lower interest rate?",
//     answer:
//       "Yes, we negotiate with lenders on your behalf to secure the best possible rates.",
//   },
//   {
//     question: "Is my information safe?",
//     answer:
//       "We use advanced encryption and comply with data protection regulations to keep your information secure.",
//   },
//   {
//     question: "How do I book?",
//     answer:
//       "You can book a consultation directly through our website or mobile app.",
//   },
//   {
//     question: "When will I receive advice?",
//     answer:
//       "Advice is typically provided within 24-48 hours after your consultation session.",
//   },
//   {
//     question: "What should I keep handy for the session?",
//     answer:
//       "Have your financial documents, goals, and any specific questions ready for the session.",
//   },
//   {
//     question: "What languages do you support?",
//     answer:
//       "We support consultations in multiple languages, including English, Hindi, and more.",
//   },
//   {
//     question: "Do you execute transactions or sell products?",
//     answer:
//       "No, we focus on advisory services and do not execute transactions or sell products.",
//   },
// ];
...
//   //   const options = {
//   //     root: null,
//   //     rootMargin: "0px 0px -50% 0px", // Trigger closer to section top
//   //     threshold: 0.5, // Trigger when 50% of the section is visible
//   //   };

//   //   const observer = new IntersectionObserver((entries) => {
//   //     // Skip observer updates if a tab was recently clicked
//   //     if (isTabClicked) return;

//   //     // Find the section closest to the top with at least 50% visibility
//   //     let closestSection = { id: activeTab, top: Infinity };
//   //     entries.forEach((entry) => {
//   //       if (entry.isIntersecting && entry.intersectionRatio >= 0.5) {
//   //         const id = entry.target.getAttribute("data-tab-id");
//   //         const top = entry.boundingClientRect.top;
//   //         if (id && top < closestSection.top) {
//   //           closestSection = { id, top };
//   //         }
//   //       }
//   //     });

//   //     if (closestSection.id !== activeTab && closestSection.id !== null) {
