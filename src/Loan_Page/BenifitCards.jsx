...
// const BenefitCards = () => {
//   return (
//     <section className="flex flex-col items-center gap-4 px-6 sm:px-10 md:px-20 lg:px-[136px] py-8 md:py-12 relative w-full mt-[-40px] md:mt-[-60px] animate-fade-in opacity-0 [--animation-delay:800ms]">
//       <div className="flex flex-col items-center w-full">
//         <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 p-6 sm:p-10 md:p-12 w-full rounded-[20px] sm:rounded-[24px] md:rounded-[28px_28px_0px_0px] shadow-[0px_-12px_11px_#00000026] bg-[linear-gradient(180deg,rgba(255,238,195,1)_0%,rgba(250,250,250,0)_100%)] bg-white border-0">
//           {benefitCards.map((card, index) => (
//             <div
//               key={card.title}
//               className={`flex flex-col items-start justify-center gap-2 p-4 w-full sm:w-[45%] md:w-[30%] lg:flex-1 rounded-lg ${
//                 index < benefitCards.length - 1
