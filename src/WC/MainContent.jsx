  ...
  const eligibilityCriteria = [
    {
      ...
      criteria: [
        "Minimum of 1 to 2 years of continuous business operations, depending on the lender",
      ],
    },
    {
      ...
      criteria: [
        "Business should have a minimum annual turnover of ₹10 Lakhs to ₹25 Lakhs (may vary by lender and loan amount)",
      ],
    },
   
    {
      ...
      image: "https://c.animaapp.com/mfwi9k86KhnY9k/img/manager-1.png",
      criteria: [
        "A healthy credit score (typically 650+ for individuals or 700+ for business entities) is preferred.",
        "A clean credit report with no recent major defaults enhances approval chances.",
      ],
    },
    {
      ...
      image: "https://c.animaapp.com/mfwi9k86KhnY9k/img/manager-1.png",
      criteria: [
        "Consistent bank transactions reflecting stable cash flow.",
        "Minimum average monthly balance and turnover based on lender criteria."
      ],
    },
  ];
...
const DocumentRequired = ({ onClose }) => {
  ...
  const documents1 = {
    ...
    "Financial Records": [
      ...
      "Latest Income Tax Returns (ITR) – 1 to 2 years",
      "Profit & Loss Statement or Audited Financials (if applicable)",
    ],
  };
...
let searchParams = useSearchParams();
  const dynamicTitle = searchParams.get("title") || "Working Capital";
  return (
    <>
