...
export default function EL_EMI(){
  return (
<div
  ...
  [background:radial-gradient(100%_100%_at_50%_100%,rgba(89,46,255,1),rgba(49,25,140,0.7)_100%),url(/bg/education-loan-emi-calculator.webp)_center/cover]"
>
