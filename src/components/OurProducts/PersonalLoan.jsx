...
import { CheckCircle, Calculator, Clock, Award, CreditCard, ChevronDown, ArrowRight } from "lucide-react";
...
const PersonalLoan = () => {
  ...
  const handleLoanAmountChange = (e) => {
    const value = Math.min(Math.max(parseInt(e.target.value) || 50000, 50000), 500000);
    setLoanAmount(value);
  };
  ...
  const personalFaqs = [
    ...
    },
    {
      ...
      answer: "Once your application is approved, the loan amount is typically disbursed within 24-48 hours directly to your bank account."
    },
    {
    ...
    },
    {
      ...
      answer: "Personal loans are multipurpose loans that can be used for medical emergencies, education, home renovation, wedding expenses, travel, or any other personal need without requiring you to specify the reason."
    }
  ];
  ...
  const instantFaqs = [
    {
      ...
      answer: "Our instant loans typically get approved within 30 minutes, provided all documentation is in order."
    },
    {
    ...
    },
    {
      ...
      answer: "While a good credit score helps, we consider various other factors for instant loans. Even those with moderate scores may qualify."
    },
    {
      question: "Can I get an instant loan without any income proof?",
      answer: "No, you'll need to provide at least basic income proof such as bank statements or salary slips for the last 3 months."
    }
  ];
          ...
          <div className="flex flex-wrap items-start">
            <div className="w-full lg:w-1/2 mb-6 lg:mb-0 pr-0 lg:pr-6">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                <div className="flex items-center bg-white px-3 py-2 rounded-lg shadow-sm hover:shadow-md transition-all">
                  ...
                  <span className="text-base font-medium">Easy Digital Process</span>
                </div>
                <div className="flex items-center bg-white px-3 py-2 rounded-lg shadow-sm hover:shadow-md transition-all">
                  <CheckCircle className="text-[#18ADA5] mr-2 h-5 w-5" />
                  <span className="text-base font-medium">Minimum Salary ₹15K</span>
                </div>
                <div className="flex items-center bg-white px-3 py-2 rounded-lg shadow-sm hover:shadow-md transition-all">
                  <CheckCircle className="text-[#18ADA5] mr-2 h-5 w-5" />
            ...
            <div className="w-full lg:w-1/2 pl-0 lg:pl-4">
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 relative transform hover:scale-[1.01] transition-transform duration-300 max-h-[580px] overflow-auto">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-3  ml-10">Calculate Loan EMI</h3>
                ...
                <div className="bg-gradient-to-br from-[#f8fcfc] to-[#eef8f8] rounded-lg p-4 flex mb-4 shadow-sm">
                  ...
                  <div className="w-1/2 pl-3">
                    <p className="text-xs text-gray-600 mb-1">Interest Payable</p>
                    <p className="text-xl font-bold text-[#18ADA5]">
                ...
                <button className="w-full bg-[#18ADA5] hover:bg-[#09615D] text-white font-medium py-2.5 rounded-md transition-all duration-300 shadow-md hover:shadow-lg transform hover:translate-y-[-2px] text-sm">
                  Apply For {activeTab === "personal" ? "Personal" : "Instant"} Loan
                </button>
              </div>
            </div>
          </div>
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                ...
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all transform hover:scale-[1.02] border border-gray-100">
                  ...
                  <h3 className="text-lg font-semibold mb-3">Quick Processing</h3>
                  <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    Get your loan application processed within 24-48 hours with minimal documentation.
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-r from-[#18ADA5] to-[#09615D] rounded-2xl p-6 sm:p-10 mb-16 text-white shadow-xl">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center">Why Choose FundsMama Personal Loans?</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  <div className="flex items-start bg-white/10 p-4 sm:p-6 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">100% Digital Journey</h3>
                      <p className="text-xs sm:text-sm">Complete application to disbursement digitally from anywhere</p>
                    </div>
                  </div>
                  <div className="flex items-start bg-white/10 p-4 sm:p-6 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all">
                    <CheckCircle className="h-6 w-6 mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <h3 className="font-semibold mb-1">No Collateral Required</h3>
                      <p className="text-xs sm:text-sm">Get approved without pledging any assets as security</p>
                    </div>
                  </div>
                  <div className="flex items-start bg-white/10 p-4 sm:p-6 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all">
                    <CheckCircle className="h-6 w-6 mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <p className="text-xs sm:text-sm">Choose repayment terms from 1-5 years that fit your budget</p>
                    </div>
                  </div>
                  <div className="flex items-start bg-white/10 p-4 sm:p-6 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all">
                    <CheckCircle className="h-6 w-6 mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <h3 className="font-semibold mb-1">No Prepayment Penalties</h3>
                      <p className="text-xs sm:text-sm">Pay off your loan early without additional charges after 6 months</p>
                    </div>
                  </div>
                  <div className="flex items-start bg-white/10 p-4 sm:p-6 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all">
                    <CheckCircle className="h-6 w-6 mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      <h3 className="font-semibold mb-1">Minimal Documentation</h3>
                      <p className="text-xs sm:text-sm">Simple application process with basic KYC requirements</p>
                    </div>
                  </div>
                  <div className="flex items-start bg-white/10 p-4 sm:p-6 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all">
                    <CheckCircle className="h-6 w-6 mr-3 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <p className="text-xs sm:text-sm">Existing customers enjoy preferential interest rates</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center mt-8">
                  <button className="bg-white text-[#18ADA5] hover:bg-gray-100 font-medium px-8 py-3 rounded-md transition-all duration-300 shadow-lg hover:shadow-xl text-base sm:text-lg transform hover:translate-y-[-2px]">
                    Apply For Personal Loan <ArrowRight className="inline ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                  </button>
                </div>
              </div>

              <div className="mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-[#163312] text-center">Eligibility Criteria</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-5 sm:p-8 border-b md:border-b-0 md:border-r border-gray-200">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-lg font-semibold">For Salaried Individuals</h3>
                      </div>
                      <ul className="space-y-3">
                        <li className="flex items-center">
                          ...
                          <span className="text-sm sm:text-base">Age: 21-58 years</span>
                        </li>
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                            <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                          </div>
                          <span className="text-sm sm:text-base">Minimum monthly income: ₹15,000</span>
                        </li>
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                            <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                          </div>
                          <span className="text-sm sm:text-base">Employment: At least 6 months in current job</span>
                        </li>
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                            <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                          </div>
                          <span className="text-sm sm:text-base">Credit Score: 650+</span>
                        </li>
                      </ul>
                    </div>
                    <div className="p-5 sm:p-8">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-lg font-semibold">For Self-Employed Individuals</h3>
                      </div>
                      <ul className="space-y-3">
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                          ...
                          <span className="text-sm sm:text-base">Age: 25-65 years</span>
                        </li>
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                            <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                          </div>
                          <span className="text-sm sm:text-base">Business vintage: Minimum 2 years</span>
                        </li>
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                            <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                          </div>
                          <span className="text-sm sm:text-base">Annual income: Minimum ₹3 lakhs</span>
                        </li>
                        <li className="flex items-center">
                          <div className="bg-[#eaf6f6] p-1 rounded-full mr-2">
                            <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                          </div>
                          <span className="text-sm sm:text-base">Credit Score: 680+</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-[#163312] text-center">Required Documents</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                  <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-base sm:text-lg font-semibold">Identity Proof</h3>
                    </div>
                    <ul className="space-y-2 ml-2">
                      ...
                      <li className="flex items-center">
                        ...
                        <span className="text-sm">Voter ID/Passport/Driving License</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-base sm:text-lg font-semibold">Address Proof</h3>
                    </div>
                    <ul className="space-y-2 ml-2">
                      <li className="flex items-center">
                        <div className="bg-[#f0f9f9] p-1 rounded-full mr-2">
                      ...
                      <li className="flex items-center">
                        ...
                        <span className="text-sm">Utility Bills (less than 3 months old)</span>
                      </li>
                      <li className="flex items-center">
                        <div className="bg-[#f0f9f9] p-1 rounded-full mr-2">
                          <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                        </div>
                        <span className="text-sm">Rental Agreement/Passport</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-base sm:text-lg font-semibold">Income Proof</h3>
                    </div>
                    <ul className="space-y-2 ml-2">
                      <li className="flex items-center">
                        <div className="bg-[#f0f9f9] p-1 rounded-full mr-2">
                        ...
                        <span className="text-sm">Last 3 months salary slips</span>
                      </li>
                      <li className="flex items-center">
                        <div className="bg-[#f0f9f9] p-1 rounded-full mr-2">
                          <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                        </div>
                        <span className="text-sm">Bank statements (last 6 months)</span>
                      </li>
                      <li className="flex items-center">
                        <div className="bg-[#f0f9f9] p-1 rounded-full mr-2">
                          <CheckCircle className="text-[#18ADA5] h-3 w-3" />
                        </div>
                        <span className="text-sm">Form 16 or ITR (for self-employed)</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              {/* Animated FAQs */}
              <div className="mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-[#163312] text-center">Personal Loan FAQs</h2>
                
                <div className="max-w-3xl mx-auto">
                  {personalFaqs.map((faq, index) => (
                    <div key={index} className="mb-3">
                      <div 
                        className={`bg-white rounded-xl transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer border ${expandedFaq === index ? 'border-[#18ADA5]' : 'border-gray-100'}`}
                        onClick={() => toggleFaq(index)}
                      >
                        <div className="flex justify-between items-center p-4 sm:p-5">
                          <h3 className={`text-base sm:text-lg font-semibold ${expandedFaq === index ? 'text-[#18ADA5]' : 'text-gray-800'}`}>
                            {faq.question}
                          </h3>
                          <ChevronDown 
                            className={`transition-transform duration-300 text-[#18ADA5] h-5 w-5 ${expandedFaq === index ? 'transform rotate-180' : ''}`} 
                          />
                        </div>
                        {expandedFaq === index && (
              ...
              <div className="text-center bg-gradient-to-br from-[#f0f9f9] to-[#ffffff] p-8 sm:p-12 rounded-2xl shadow-sm">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-[#163312]">Ready to Get Started?</h2>
                <button className="bg-[#18ADA5] hover:bg-[#09615D] text-white font-medium px-8 sm:px-12 py-3 sm:py-4 rounded-md transition-all duration-300 shadow-md hover:shadow-xl text-base sm:text-lg transform hover:translate-y-[-2px]">
                  Apply Now <ArrowRight className="inline ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </button>
            ...
            <div>
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-16">
                <div className="bg-gradient-to-r from-[#18ADA5] to-[#09615D] p-6 sm:p-10 text-white">
                  <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Instant Loans - Quick Cash When You Need It</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 p-5 sm:p-8">
                  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all transform hover:scale-[1.02] border border-gray-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-base sm:text-lg font-semibold">Same Day Disbursal</h3>
                    </div>
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all transform hover:scale-[1.02] border border-gray-100">
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-base sm:text-lg font-semibold">Minimal Documentation</h3>
                    </div>
                    <p className="text-gray-600 text-sm">
              ...
              <div className="mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-[#163312] text-center">Features of Instant Loans</h2>
                  ...
                  <div>
                    <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100 mb-6">
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-lg font-semibold">Completely Digital Process</h3>
                      </div>
                      <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                        Apply online through our app or website without visiting any branch. Complete the entire process from application to approval digitally.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100 mb-6">
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-lg font-semibold">Quick Approval</h3>
                      </div>
                      <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                        Get loan approval within 30 minutes with our AI-powered approval system that quickly verifies your eligibility.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100">
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-lg font-semibold">Flexible Repayment</h3>
                      </div>
                      <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                        Choose from tenures ranging from 3 months to 36 months based on your repayment capacity.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100 mb-6">
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-lg font-semibold">No Hidden Charges</h3>
                      </div>
                      <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                        Transparent fee structure with clearly mentioned processing fees and interest rates. No surprise charges.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100 mb-6">
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="text-lg font-semibold">Small Ticket Sizes</h3>
                      </div>
                      <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                        Borrow as low as ₹10,000 for your immediate needs without taking on a larger loan than necessary.
                      </p>
                    </div>
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-100">
                      ...
                      <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                        Regular repayment builds your credit profile for easier renewals and higher loan amounts in the future.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-[#163312] text-center">Instant Loan Eligibility</h2>
                  ...
                  <div className="p-5 sm:p-8">
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <li className="flex items-start bg-[#f8fcfc] p-4 rounded-xl">
                        ...
                        <div>
                          <span className="font-semibold block mb-1 text-sm sm:text-base">Age Requirement</span>
                          <span className="text-gray-600 text-sm">21-55 years</span>
                        </div>
                      </li>
                      <li className="flex items-start bg-[#f8fcfc] p-4 rounded-xl">
                        <div className="bg-[#eaf6f6] p-1 rounded-full mr-3 mt-1">
                        ...
                        <div>
                          <span className="font-semibold block mb-1 text-sm sm:text-base">Income</span>
                          <span className="text-gray-600 text-sm">Minimum monthly income of ₹15,000 for salaried individuals</span>
                        </div>
                      </li>
                      <li className="flex items-start bg-[#f8fcfc] p-4 rounded-xl">
                        <div className="bg-[#eaf6f6] p-1 rounded-full mr-3 mt-1">
                        ...
                        <div>
                          <span className="font-semibold block mb-1 text-sm sm:text-base">Employment</span>
                          <span className="text-gray-600 text-sm">At least 3 months in current job</span>
                        </div>
                      </li>
                      <li className="flex items-start bg-[#f8fcfc] p-4 rounded-xl">
                        <div className="bg-[#eaf6f6] p-1 rounded-full mr-3 mt-1">
                        ...
                        <div>
                          <span className="font-semibold block mb-1 text-sm sm:text-base">Residence</span>
                          <span className="text-gray-600 text-sm">Should be a resident of India</span>
                        </div>
                      </li>
                      <li className="flex items-start bg-[#f8fcfc] p-4 rounded-xl md:col-span-2">
                        ...
                        <div>
                          <span className="font-semibold block mb-1 text-sm sm:text-base">Documentation</span>
                          <span className="text-gray-600 text-sm">Valid ID proof, address proof, and bank statements for the last 3 months</span>
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="bg-gradient-to-r from-[#18ADA5] to-[#09615D] rounded-xl overflow-hidden shadow-xl">
                  <div className="flex flex-col md:flex-row items-center p-6 sm:p-8">
                    <div className="md:w-2/3 mb-6 md:mb-0 md:pr-6">
                      <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-white">Need Urgent Funds?</h2>
                      <p className="text-white/90 mb-5 text-sm sm:text-base">
                        Don't wait for days to get your loan approved. Our Instant Loan gets you the funds when you need them the most.
                      </p>
                      <ul className="space-y-3 mb-6">
                        <li className="flex items-center text-white">
                          ...
                          <span className="text-sm sm:text-base">Fast approval in under 30 minutes</span>
                        </li>
                        <li className="flex items-center text-white">
                          <div className="bg-white/20 p-1.5 rounded-full mr-3">
                            <CheckCircle className="h-4 w-4" />
                          </div>
                          <span className="text-sm sm:text-base">Same day disbursal directly to your bank</span>
                        </li>
                        <li className="flex items-center text-white">
                          <div className="bg-white/20 p-1.5 rounded-full mr-3">
                            <CheckCircle className="h-4 w-4" />
                          </div>
                          <span className="text-sm sm:text-base">Completely paperless process</span>
                        </li>
                      </ul>
                      <button className="bg-white text-[#18ADA5] hover:bg-gray-50 font-medium px-6 py-3 rounded-md transition-all duration-300 shadow-md hover:shadow-lg transform hover:translate-y-[-2px] text-sm sm:text-base">
                        Apply For Instant Loan <ArrowRight className="inline ml-2 h-4 w-4" />
                      </button>
                    </div>
                    <div className="md:w-1/3">
                      <div className="bg-white p-5 rounded-xl text-center text-gray-800 shadow-lg transform md:translate-x-4 hover:scale-[1.02] transition-transform">
                        <p className="text-lg font-bold mb-2">Loan Process Time</p>
                        <div className="bg-[#f0f9f9] rounded-lg p-3 mb-4">
                          <p className="text-3xl font-bold text-[#18ADA5] mb-0">30 min</p>
                        ...
                        <div className="bg-[#f0f9f9] rounded-lg p-3">
                          <p className="text-3xl font-bold text-[#18ADA5] mb-0">2-6 hrs</p>
              ...
              <div className="mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-[#163312] text-center">Instant Loan FAQs</h2>
                
                <div className="max-w-3xl mx-auto">
                  {instantFaqs.map((faq, index) => (
                    <div key={index} className="mb-3">
                      <div 
                        className={`bg-white rounded-xl transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer border ${expandedFaq === (index + 100) ? 'border-[#18ADA5]' : 'border-gray-100'}`}
                        onClick={() => toggleFaq(index + 100)}
                      >
                        <div className="flex justify-between items-center p-4 sm:p-5">
                          <h3 className={`text-base sm:text-lg font-semibold ${expandedFaq === (index + 100) ? 'text-[#18ADA5]' : 'text-gray-800'}`}>
                            {faq.question}
                          </h3>
                          <ChevronDown 
                            className={`transition-transform duration-300 text-[#18ADA5] h-5 w-5 ${expandedFaq === (index + 100) ? 'transform rotate-180' : ''}`} 
                          />
                        </div>
              ...
              <div className="text-center bg-gradient-to-br from-[#f0f9f9] to-[#ffffff] p-8 sm:p-12 rounded-2xl shadow-sm">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-[#163312]">Ready for Instant Cash?</h2>
                <button className="bg-[#18ADA5] hover:bg-[#09615D] text-white font-medium px-8 sm:px-12 py-3 sm:py-4 rounded-md transition-all duration-300 shadow-md hover:shadow-xl text-base sm:text-lg transform hover:translate-y-[-2px]">
                  Apply for Instant Loan <ArrowRight className="inline ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </button>
                <p className="mt-4 text-gray-600 text-sm sm:text-base">
