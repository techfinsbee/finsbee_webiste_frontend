...
// export default function ExpandingCards() {
//   const [active, setActive] = useState(1);
//   // Media query for desktop - min-width 768px (adjust as needed)
...
//       {isDesktop && (
//         <div className="flex justify-center mx-auto w-full py-12 md:px-[136px] gap-[15.3px] h-[386px] max-w-[1400px]">
//           {cards.map((card) => {
//             const isActive = active === card.id;
//             return (
//               <motion.div
...
//           viewport={{ once: true, amount: 0.1 }}
//         >
//           <h3 className="font-bold text-[16px] text-[#212121]">
//             The Results Speaks for Themselves
//           </h3>
//           <div className="flex flex-wrap w-full items-start gap-[10px]">
//             <h1 className="w-full font-bold text-[64px] leading-normal text-[#212121] font-['Lato',sans-serif]">
...
//       {/* Desktop / Large Screen Cards */}
//       <div className="hidden md:flex justify-center mx-auto w-full py-12 h-[386px] md:px-[136px] gap-[15.3px]">
//         {cards.map((card) => {
//           const isActive = active === card.id;
//           return (
//             <motion.div
...
//       <motion.div
//         className="flex md:hidden gap-4 px-4 pb-4 overflow-x-scroll no-scrollbar cursor-grab active:cursor-grabbing"
//         drag="x"
...
//           <motion.div
//             key={card.id}
//             className="min-w-[280px] max-w-[280px] h-[386px] rounded-2xl shadow-md bg-gray-100 flex flex-col justify-between p-6"
//             whileTap={{ scale: 0.97 }}
//           >
//             <div className="p-2">
//               <span className="text-lg">∞</span>
