  ...
  return (
    <section className="py-10 px-4 lg:px-4 reward-section lg:ml-10 lg:mr-[50px] ">
      <div className="grid grid-cols-1 md:grid-cols-2 rewards " style={{}}>
        {/* Left box - FBCoins */}
        <div className={`${COLOR?"bg-[#ffc73c]":"bg-[#FEFFC5]"} h-[500px] rounded-2xl px-8 pt-8 object-cover overflow-hidden box-1 flex flex-col w-[96%] ml-2`}>
          <div className="">
            <h2
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className={`${COLOR?"bg-[#fff0cc]":"bg-[#CAFFDC]"} reward-3 rounded-2xl overflow-hidden pl-4 flex justify-between items-center w-[95%]`}>
            <div>
              <h2
