...
export default function BookingHero() {
  ...
  useEffect(() => {
    ...
    const io1 = new IntersectionObserver(([e]) => {
      if (e.isIntersecting) { setShowForm(true); io1.disconnect(); }
    }, opts);
    const io2 = new IntersectionObserver(([e]) => {
      if (e.isIntersecting) { setShowLeft(true); io2.disconnect(); }
    }, opts);
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
          // slightly stronger on the left – matches Figma tint
          background:
      ...
      <div className="relative min-h-[786px] lg:h-[786px]">
        <div className="mx-auto max-w-7xl h-full px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center h-full py-10 sm:py-0">
              ...
              <div className="w-full max-w-[512px]">
                ...
                <h2
                  className="
                    ...
                    tracking-[-0.01em] font-[Lato,var(--font-lato),sans-serif]
                  "
                >
                  Simple Plans
                  <br />
                ...
                {/* Stat tiles – match spacing/shape */}
            ...
            >
              {/* wrapper shade/ring to match Figma */}
