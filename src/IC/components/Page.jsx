...
const [showFlutter, setShowFlutter] = useState(false);
 ...
 useEffect(() => {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row gap-8  sm:px-8 md:px-16 lg:px-[136px] py-12 md:py-16 lg:py-24 bg-white min-h-screen">
      {/* ====================== LEFT SECTION ====================== */}
      <div className="w-full lg:w-2/3">
        <div className="flex flex-col items-start w-full">
          ...
          <div className="w-full pt-16">
            ...
            >
              <h2 className="font-bold text-xl mb-2 tp-5">
